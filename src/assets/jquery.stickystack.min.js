(function ($, undefined) {
    ...
    console.log('options', options);
		...
		// Variables setup
		let $sections = $(`${options.containerElement} > ${options.stackingElement}`);
    let	sectionsInfo = [];
    ...
    console.log('$sections', $sections);
      ...
      counter = 0;
          ...
          console.log(windowScrollPos)
					...
					console.log(windowScrollPos >= sectionsInfo[i][2] + sectionsInfo[i][0])
