    ...
    module.exports = {
        methods: {
            addMod() {
                ...
                store.commit('addModToDish', {'modData': modData, 'id': this.dishId});
            },
            removeMod() {

                store.commit('removeModFromDish', {'modId': this.data.id_Mod, 'id': this.dishId});
            },
            incModCount() {
                store.commit('incModCount', {'modId': this.data.id_Mod, 'id': this.dishId});
            },
            decModCount() {
                store.commit('decModCount', {'modId': this.data.id_Mod, 'id': this.dishId});
            },
        },
        created() {
        ...
        computed: {
            ...
            getCount: function () {
                ...
                const dish = store.state.cart.find(p => p.id === this.dishId);
